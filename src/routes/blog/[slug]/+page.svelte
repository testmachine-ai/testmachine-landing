...
<article class="article-body container">
  ...
  {:else if post.slug === 'predator-vs-euler'}
  ...
  {:else if post.slug === 'funding-announcement'}
    <p><em>TestMachine has raised $6.5M to scale Predator, its AI platform monitoring 1M+ tokens and delivering real-time blockchain security for exchanges, developers, and DeFi.</em></p>
