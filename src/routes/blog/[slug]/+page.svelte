...
<article class="article-body container">
  ...
  {:else if post.slug === 'breaking-tokenomics'}
    <h3>Introduction</h3>
    ...
    <p>Want to ensure your contracts are secure? <a href="https://app.testmachine.ai/">Run a Token Custody scan today</a>.</p>

  {:else if post.slug === 'funding-announcement'}
    <p><em>TestMachine has raised $6.5M to scale Token Custody and Azimuth, its AI products monitoring 1M+ tokens and delivering real-time blockchain security for exchanges, developers, and DeFi.</em></p>

    <p><a href="http://www.testmachine.ai/">TestMachine</a>, the AI-driven blockchain security company safeguarding billions in digital assets, today announced it has raised $6.5 million in venture funding to accelerate the global rollout of its flagship products, Token Custody and Azimuth. The round was led by BlockChange Ventures, Decasonic, Delphi Ventures, and New Form Capital. The investment will accelerate the development and deployment of TestMachine's flagship AI products, Token Custody and Azimuth, which are now fully integrated into Coinbase's token security and deployment process.</p>
  ...
  {:else if post.slug === 'testmachine-vs-llms'}
    <p><em>Why reinforcement learning outperforms large language models for smart contract security analysis.</em></p>
